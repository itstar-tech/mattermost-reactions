...
show_help() {
    ...
    echo "  start     - Inicia Mattermost server y webhook receiver"
...
start_services() {
    ...
    # Crear el plugin antes de iniciar si no existe
...
# Ver logs de Mattermost
show_logs() {
    print_status "Mostrando logs de Mattermost..."
    detect_docker_compose
    $DOCKER_COMPOSE -f docker-compose.dev.yml logs -f mattermost
}
...
show_webhook_logs() {
    ...
    detect_docker_compose
    $DOCKER_COMPOSE -f docker-compose.dev.yml logs -f webhook-receiver
}
